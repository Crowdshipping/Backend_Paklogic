...
import {createComplain, LogoutApi} from '../../../API';
    ...
    <SafeAreaView>
      <ScrollView>
        ...
        <View style={styles.maincontainer}>
          ...
          {!isComplainDescription && (
            <Text style={{color: colors.red, marginLeft: '2%'}}>
              Complain descripton is required
            </Text>
          )}
          {!isComplainDescriptionLength && (
            <Text style={{color: colors.red, marginLeft: '2%'}}>
              Complain descripton have at least 10 words
            </Text>
          )}
